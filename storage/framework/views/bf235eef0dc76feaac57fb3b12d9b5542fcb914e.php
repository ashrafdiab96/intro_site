...
<head>
    ...
    <title><?php echo app('translator')->get('app.notfound'); ?></title>
    ...
    <?php if(Session()->get('front-locale') == 'ar'): ?>
...
<?php /**PATH C:\xampp\htdocs\intro\resources\views/frontend/notfound.blade.php ENDPATH**/ ?>